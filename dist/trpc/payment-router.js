...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, filterProducts, order, line_items, stripeSession, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        filterProducts = products.filter(function (product) { return Boolean(product.priceId); });
